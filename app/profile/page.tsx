...
const ALL_FRIENDS: Friend[] = [
  { id: 1,  name: "Sarah Kim",    username: "sarahkim",    status: "online",  initials: "SK", mutualFriends: 12 },
  { id: 2,  name: "James Park",   username: "jamespark",   status: "online",  initials: "JP", mutualFriends: 8  },
  { id: 3,  name: "Mia Torres",   username: "miatorres",   status: "offline", initials: "MT", mutualFriends: 5  },
  { id: 4,  name: "Lucas Ng",     username: "lucasng",     status: "offline", initials: "LN", mutualFriends: 3  },
  { id: 5,  name: "Priya Raj",    username: "priyaraj",    status: "online",  initials: "PR", mutualFriends: 7  },
  { id: 6,  name: "Ethan Wu",     username: "ethanwu",     status: "offline", initials: "EW", mutualFriends: 2  },
  { id: 7,  name: "Nina Cheng",   username: "ninacheng",   status: "online",  initials: "NC", mutualFriends: 9  },
  { id: 8,  name: "Omar Hassan",  username: "omarhassan",  status: "offline", initials: "OH", mutualFriends: 4  },
  { id: 9,  name: "Lily Zhang",   username: "lilyzhang",   status: "online",  initials: "LZ", mutualFriends: 6  },
  { id: 10, name: "Carlos Rivas", username: "carlosrivas", status: "offline", initials: "CR", mutualFriends: 1  },
  { id: 11, name: "Aisha Malik",  username: "aishamalik",  status: "online",  initials: "AM", mutualFriends: 10 },
  { id: 12, name: "Ben Foster",   username: "benfoster",   status: "offline", initials: "BF", mutualFriends: 3  },
];
...
export default function ProfilePage() {
  ...
  const [profile, setProfile] = useState<Profile>({
    ...
    bio:      "Building things on the internet. Love clean design and fast code.",
  ...
  const editFields: { label: string; key: keyof Profile; placeholder: string }[] = [
  ...
  const onlineCount  = activeFriends.filter((f) => f.status !== "offline").length;
  const offlineCount = activeFriends.filter((f) => f.status === "offline").length;
              ...
              {editing ? (
                ...
                <>
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    {profile.website && (
                      <div className="flex items-center gap-2">
                        <Link2 size={13} className="text-foreground/60 shrink-0" />
                        <span className="text-sm font-semibold">{profile.website}</span>
                      </div>
                    )}
                  </div>

                  <div className="mt-5">
                    <Badge variant="secondary" className="gap-1.5 rounded-full px-3 py-1 font-semibold text-xs">
                          ...
                          <div className="flex items-center gap-3 px-4 py-3 hover:bg-muted/50 transition-colors duration-150">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs text-muted-foreground truncate">
                                @{f.username}
                                {f.mutualFriends > 0 && (
                                  <span className="ml-1.5 opacity-50">· {f.mutualFriends} mutual</span>
                                )}
                              </p>
                            </div>
                            ...
                            <Badge
                              ...
                              className={cn(
                                ...
                                f.status === "online" && "bg-green-500/10 text-green-600 dark:text-green-400",
                                f.status === "away"   && "bg-amber-400/10 text-amber-600 dark:text-amber-400",
                              )}
                            >
                            ...
                            <div className="flex items-center gap-1.5 shrink-0">
                              <Tooltip>
                                ...
                                <TooltipContent className="text-xs sm:hidden">Message</TooltipContent>
                              </Tooltip>
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent className="text-xs">Remove friend</TooltipContent>
                              </Tooltip>
                            </div>
                          </div>
